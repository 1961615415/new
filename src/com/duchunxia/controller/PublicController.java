...
public class PublicController {
	...
	@RequestMapping(value = { "/index.shtml" }, method = { RequestMethod.POST,
			RequestMethod.GET })
	 @ApiOperation(value="登录系统接口,获取所有用户信息",notes="requires noting")
	...
	@RequestMapping(value = { "/echarts.shtml" }, method = {
	 ...
	 @ApiOperation(value="美女图接口",notes="requires noting")
	@ResponseBody
...
@ApiOperation(value="修改宫女信息接口",notes="requires id【宫女ID】")
